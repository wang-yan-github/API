...
public class ZtzdHdglzAction extends HttpServlet {

    private ZtzdHdglzService ztzdHdglzService = (ZtzdHdglzService)new TransactionUtil().newProxy(new ZtzdHdglzServiceImpl());
    ...
    private Result save() {
        ...
        if(!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtzdHdglz ztzdHdglz = new ZtzdHdglz();
            ztzdHdglz.setTitle(title);
            ztzdHdglz.setContent(content);
            ztzdHdglz.setDate(date);
            ztzdHdglz.setPerson(person);
            ztzdHdglz.setDepartment(department);
            ztzdHdglz.setQuality(quality);
            ztzdHdglz.setPeople(people);
            ztzdHdglzService.save(ztzdHdglz);
            map.put("ztzdHdglz", ztzdHdglz);
    ...
    private Result remove() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            ...
            map.put("ztzdHdglz", ztzdHdglzService.find(i));
            ztzdHdglzService.remove(i);
    ...
    private Result update() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)&&!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtzdHdglz ztzdHdglz = new ZtzdHdglz();
            ztzdHdglz.setId(Integer.parseInt(id));
            ztzdHdglz.setTitle(title);
            ztzdHdglz.setContent(content);
            ztzdHdglz.setDate(date);
            ztzdHdglz.setPerson(person);
            ...
            ztzdHdglz.setQuality(quality);
            ztzdHdglz.setPeople(people);
            ztzdHdglzService.update(ztzdHdglz);
            map.put("ztzdHdglz", ztzdHdglz);
    ...
    private Result list() {
    	...
    	LiuLiang ll = liuLiangService.find("content = 'ZtzdHdglz' ",null);
        ...
        if(!"".equals(where)&&where!=null){
            message = JSONUtils.toJSONString(ztzdHdglzService.list(" title LIKE '%"+where+"%' OR content LIKE '%"+where+"%'  ",null));
        }else{
            message = JSONUtils.toJSONString(ztzdHdglzService.list());
        }
    ...
    private Result find() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            int i = Integer.parseInt(id);
            message = JSONUtils.toJSONString(ztzdHdglzService.find(i));
        }
