...
import cn.wangyanfsd.api.bean.ZtyjHdglz;
...
public class ZtyjHdglzAction extends HttpServlet {

    private ZtyjHdglzService ztyjHdglzService = (ZtyjHdglzService)new TransactionUtil().newProxy(new ZtyjHdglzServiceImpl());
    ...
    private Result save() {
        ...
        if(!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtyjHdglz ztyjHdglz = new ZtyjHdglz();
            ztyjHdglz.setTitle(title);
            ztyjHdglz.setContent(content);
            ztyjHdglz.setDate(date);
            ztyjHdglz.setPerson(person);
            ztyjHdglzService.save(ztyjHdglz);
            map.put("ztyjHdglz", ztyjHdglz);
    ...
    private Result remove() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            ...
            map.put("ztyjHdglz", ztyjHdglzService.find(i));
            ztyjHdglzService.remove(i);
    ...
    private Result update() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)&&!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtyjHdglz ztyjHdglz = new ZtyjHdglz();
            ztyjHdglz.setId(Integer.parseInt(id));
            ztyjHdglz.setTitle(title);
            ztyjHdglz.setContent(content);
            ztyjHdglz.setDate(date);
            ztyjHdglz.setPerson(person);
            ztyjHdglzService.update(ztyjHdglz);
            map.put("ztyjHdglz", ztyjHdglz);
    ...
    private Result list() {
    	...
    	LiuLiang ll = liuLiangService.find("content = 'ZtyjHdglz' ",null);
        ...
        if(!"".equals(where)&&where!=null){
            message = JSONUtils.toJSONString(ztyjHdglzService.list(" title LIKE '%"+where+"%' OR content LIKE '%"+where+"%'  ",null));
        }else{
            message = JSONUtils.toJSONString(ztyjHdglzService.list());
        }
    ...
    private Result find() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            int i = Integer.parseInt(id);
            message = JSONUtils.toJSONString(ztyjHdglzService.find(i));
        }
