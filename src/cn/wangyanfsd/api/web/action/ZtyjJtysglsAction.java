...
import cn.wangyanfsd.api.bean.ZtyjJtysgls;
...
public class ZtyjJtysglsAction extends HttpServlet {

    private ZtyjJtysglsService ztyjJtysglsService = (ZtyjJtysglsService)new TransactionUtil().newProxy(new ZtyjJtysglsServiceImpl());
    ...
    private Result save() {
        ...
        if(!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtyjJtysgls ztyjJtysgls = new ZtyjJtysgls();
            ztyjJtysgls.setTitle(title);
            ztyjJtysgls.setContent(content);
            ztyjJtysgls.setDate(date);
            ztyjJtysgls.setPerson(person);
            ztyjJtysglsService.save(ztyjJtysgls);
            map.put("ztyjJtysgls", ztyjJtysgls);
    ...
    private Result remove() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            ...
            map.put("ztyjJtysgls", ztyjJtysglsService.find(i));
            ztyjJtysglsService.remove(i);
    ...
    private Result update() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)&&!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtyjJtysgls ztyjJtysgls = new ZtyjJtysgls();
            ztyjJtysgls.setId(Integer.parseInt(id));
            ztyjJtysgls.setTitle(title);
            ztyjJtysgls.setContent(content);
            ztyjJtysgls.setDate(date);
            ztyjJtysgls.setPerson(person);
            ztyjJtysglsService.update(ztyjJtysgls);
            map.put("ztyjJtysgls", ztyjJtysgls);
    ...
    private Result list() {
    	...
    	LiuLiang ll = liuLiangService.find("content = 'ZtyjJtysgls' ",null);
        ...
        if(!"".equals(where)&&where!=null){
            message = JSONUtils.toJSONString(ztyjJtysglsService.list(" title LIKE '%"+where+"%' OR content LIKE '%"+where+"%'  ",null));
        }else{
            message = JSONUtils.toJSONString(ztyjJtysglsService.list());
        }
    ...
    private Result find() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            int i = Integer.parseInt(id);
            message = JSONUtils.toJSONString(ztyjJtysglsService.find(i));
        }
