...
public class ZtzdGlglzAction extends HttpServlet {

    private ZtzdGlglzService ztzdGlglzService = (ZtzdGlglzService)new TransactionUtil().newProxy(new ZtzdGlglzServiceImpl());
    ...
    private Result save() {
        ...
        if(!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtzdGlglz ztzdGlglz = new ZtzdGlglz();
            ztzdGlglz.setTitle(title);
            ztzdGlglz.setContent(content);
            ztzdGlglz.setDate(date);
            ztzdGlglz.setPerson(person);
            ztzdGlglz.setDepartment(department);
            ztzdGlglz.setQuality(quality);
            ztzdGlglz.setPeople(people);
            ztzdGlglzService.save(ztzdGlglz);
            map.put("ztzdGlglz", ztzdGlglz);
    ...
    private Result remove() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            ...
            map.put("ztzdGlglz", ztzdGlglzService.find(i));
            ztzdGlglzService.remove(i);
    ...
    private Result update() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)&&!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtzdGlglz ztzdGlglz = new ZtzdGlglz();
            ztzdGlglz.setId(Integer.parseInt(id));
            ztzdGlglz.setTitle(title);
            ztzdGlglz.setContent(content);
            ztzdGlglz.setDate(date);
            ztzdGlglz.setPerson(person);
            ...
            ztzdGlglz.setQuality(quality);
            ztzdGlglz.setPeople(people);
            ztzdGlglzService.update(ztzdGlglz);
            map.put("ztzdGlglz", ztzdGlglz);
    ...
    private Result list() {
    	...
    	LiuLiang ll = liuLiangService.find("content = 'ZtzdGlglz' ",null);
        ...
        if(!"".equals(where)&&where!=null){
            message = JSONUtils.toJSONString(ztzdGlglzService.list(" title LIKE '%"+where+"%' OR content LIKE '%"+where+"%'  ",null));
        }else{
            message = JSONUtils.toJSONString(ztzdGlglzService.list());
        }
    ...
    private Result find() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            int i = Integer.parseInt(id);
            message = JSONUtils.toJSONString(ztzdGlglzService.find(i));
        }
