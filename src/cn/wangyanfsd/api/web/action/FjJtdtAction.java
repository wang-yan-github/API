...
import cn.wangyanfsd.api.bean.FjJtdt;
...
public class FjJtdtAction extends HttpServlet {

    private FjJtdtService fjJtdtService = (FjJtdtService)new TransactionUtil().newProxy(new FjJtdtServiceImpl());
    ...
    private Result save() {
        ...
        if(!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            FjJtdt fjJtdt = new FjJtdt();
            fjJtdt.setTitle(title);
            fjJtdt.setContent(content);
            fjJtdt.setDate(date);
            fjJtdt.setPerson(person);
            fjJtdtService.save(fjJtdt);
            map.put("fjJtdt", fjJtdt);
    ...
    private Result remove() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            ...
            map.put("fjJtdt", fjJtdtService.find(i));
            fjJtdtService.remove(i);
    ...
    private Result update() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)&&!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            FjJtdt fjJtdt = new FjJtdt();
            fjJtdt.setId(Integer.parseInt(id));
            fjJtdt.setTitle(title);
            fjJtdt.setContent(content);
            fjJtdt.setDate(date);
            fjJtdt.setPerson(person);
            fjJtdtService.update(fjJtdt);
            map.put("fjJtdt", fjJtdt);
    ...
    private Result list() {
        ...
        if(!"".equals(where)&&where!=null){
            message = JSONUtils.toJSONString(fjJtdtService.list(" title LIKE '%"+where+"%' OR content LIKE '%"+where+"%'  ",null));
        }else{
            message = JSONUtils.toJSONString(fjJtdtService.list());
        }
    ...
    private Result find() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            int i = Integer.parseInt(id);
            message = JSONUtils.toJSONString(fjJtdtService.find(i));
        }
