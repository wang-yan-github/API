...
public class ZtzdDfhscAction extends HttpServlet {

    private ZtzdDfhscService ztzdDfhscService = (ZtzdDfhscService)new TransactionUtil().newProxy(new ZtzdDfhscServiceImpl());
    ...
    private Result save() {
        ...
        if(!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtzdDfhsc ztzdDfhsc = new ZtzdDfhsc();
            ztzdDfhsc.setTitle(title);
            ztzdDfhsc.setContent(content);
            ztzdDfhsc.setDate(date);
            ztzdDfhsc.setPerson(person);
            ztzdDfhsc.setDepartment(department);
            ztzdDfhsc.setQuality(quality);
            ztzdDfhsc.setPeople(people);
            ztzdDfhscService.save(ztzdDfhsc);
            map.put("ztzdDfhsc", ztzdDfhsc);
    ...
    private Result remove() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            ...
            map.put("ztzdDfhsc", ztzdDfhscService.find(i));
            ztzdDfhscService.remove(i);
    ...
    private Result update() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)&&!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtzdDfhsc ztzdDfhsc = new ZtzdDfhsc();
            ztzdDfhsc.setId(Integer.parseInt(id));
            ztzdDfhsc.setTitle(title);
            ztzdDfhsc.setContent(content);
            ztzdDfhsc.setDate(date);
            ztzdDfhsc.setPerson(person);
            ...
            ztzdDfhsc.setQuality(quality);
            ztzdDfhsc.setPeople(people);
            ztzdDfhscService.update(ztzdDfhsc);
            map.put("ztzdDfhsc", ztzdDfhsc);
    ...
    private Result list() {
    	...
    	LiuLiang ll = liuLiangService.find("content = 'ZtzdDfhsc' ",null);
        ...
        if(!"".equals(where)&&where!=null){
            message = JSONUtils.toJSONString(ztzdDfhscService.list(" title LIKE '%"+where+"%' OR content LIKE '%"+where+"%'  ",null));
        }else{
            message = JSONUtils.toJSONString(ztzdDfhscService.list());
        }
    ...
    private Result find() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            int i = Integer.parseInt(id);
            message = JSONUtils.toJSONString(ztzdDfhscService.find(i));
        }
