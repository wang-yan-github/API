...
import cn.wangyanfsd.api.bean.ZfqxJcsx;
...
public class ZfqxJcsxAction extends HttpServlet {

    private ZfqxJcsxService zfqxJcsxService = (ZfqxJcsxService)new TransactionUtil().newProxy(new ZfqxJcsxServiceImpl());
    ...
    private Result save() {
        ...
        if(!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZfqxJcsx zfqxJcsx = new ZfqxJcsx();
            zfqxJcsx.setTitle(title);
            zfqxJcsx.setContent(content);
            zfqxJcsx.setDate(date);
            zfqxJcsx.setPerson(person);
            zfqxJcsxService.save(zfqxJcsx);
            map.put("zfqxJcsx", zfqxJcsx);
    ...
    private Result remove() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            ...
            map.put("zfqxJcsx", zfqxJcsxService.find(i));
            zfqxJcsxService.remove(i);
    ...
    private Result update() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)&&!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZfqxJcsx zfqxJcsx = new ZfqxJcsx();
            zfqxJcsx.setId(Integer.parseInt(id));
            zfqxJcsx.setTitle(title);
            zfqxJcsx.setContent(content);
            zfqxJcsx.setDate(date);
            zfqxJcsx.setPerson(person);
            zfqxJcsxService.update(zfqxJcsx);
            map.put("zfqxJcsx", zfqxJcsx);
    ...
    private Result list() {
    	...
    	LiuLiang ll = liuLiangService.find("content = 'ZfqxJcsx' ",null);
        ...
        if(!"".equals(where)&&where!=null){
            message = JSONUtils.toJSONString(zfqxJcsxService.list(" title LIKE '%"+where+"%' OR content LIKE '%"+where+"%'  ",null));
        }else{
            message = JSONUtils.toJSONString(zfqxJcsxService.list());
        }
    ...
    private Result find() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            int i = Integer.parseInt(id);
            message = JSONUtils.toJSONString(zfqxJcsxService.find(i));
        }
