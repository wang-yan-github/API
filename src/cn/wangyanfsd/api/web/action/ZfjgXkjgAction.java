...
import cn.wangyanfsd.api.bean.ZfjgXkjg;
...
public class ZfjgXkjgAction extends HttpServlet {

    private ZfjgXkjgService zfjgXkjgService = (ZfjgXkjgService)new TransactionUtil().newProxy(new ZfjgXkjgServiceImpl());
    ...
    private Result save() {
        ...
        if(!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZfjgXkjg zfjgXkjg = new ZfjgXkjg();
            zfjgXkjg.setTitle(title);
            zfjgXkjg.setContent(content);
            zfjgXkjg.setDate(date);
            zfjgXkjg.setPerson(person);
            zfjgXkjgService.save(zfjgXkjg);
            map.put("zfjgXkjg", zfjgXkjg);
    ...
    private Result remove() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            ...
            map.put("zfjgXkjg", zfjgXkjgService.find(i));
            zfjgXkjgService.remove(i);
    ...
    private Result update() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)&&!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZfjgXkjg zfjgXkjg = new ZfjgXkjg();
            zfjgXkjg.setId(Integer.parseInt(id));
            zfjgXkjg.setTitle(title);
            zfjgXkjg.setContent(content);
            zfjgXkjg.setDate(date);
            zfjgXkjg.setPerson(person);
            zfjgXkjgService.update(zfjgXkjg);
            map.put("zfjgXkjg", zfjgXkjg);
    ...
    private Result list() {
    	...
    	LiuLiang ll = liuLiangService.find("content = 'ZfjgXkjg' ",null);
        ...
        if(!"".equals(where)&&where!=null){
            message = JSONUtils.toJSONString(zfjgXkjgService.list(" title LIKE '%"+where+"%' OR content LIKE '%"+where+"%'  ",null));
        }else{
            message = JSONUtils.toJSONString(zfjgXkjgService.list());
        }
    ...
    private Result find() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            int i = Integer.parseInt(id);
            message = JSONUtils.toJSONString(zfjgXkjgService.find(i));
        }
