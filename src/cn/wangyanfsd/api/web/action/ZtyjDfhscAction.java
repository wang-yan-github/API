...
import cn.wangyanfsd.api.bean.ZtyjDfhsc;
...
public class ZtyjDfhscAction extends HttpServlet {

    private ZtyjDfhscService ztyjDfhscService = (ZtyjDfhscService)new TransactionUtil().newProxy(new ZtyjDfhscServiceImpl());
    ...
    private Result save() {
        ...
        if(!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtyjDfhsc ztyjDfhsc = new ZtyjDfhsc();
            ztyjDfhsc.setTitle(title);
            ztyjDfhsc.setContent(content);
            ztyjDfhsc.setDate(date);
            ztyjDfhsc.setPerson(person);
            ztyjDfhscService.save(ztyjDfhsc);
            map.put("ztyjDfhsc", ztyjDfhsc);
    ...
    private Result remove() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            ...
            map.put("ztyjDfhsc", ztyjDfhscService.find(i));
            ztyjDfhscService.remove(i);
    ...
    private Result update() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)&&!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtyjDfhsc ztyjDfhsc = new ZtyjDfhsc();
            ztyjDfhsc.setId(Integer.parseInt(id));
            ztyjDfhsc.setTitle(title);
            ztyjDfhsc.setContent(content);
            ztyjDfhsc.setDate(date);
            ztyjDfhsc.setPerson(person);
            ztyjDfhscService.update(ztyjDfhsc);
            map.put("ztyjDfhsc", ztyjDfhsc);
    ...
    private Result list() {
    	...
    	LiuLiang ll = liuLiangService.find("content = 'ZtyjDfhsc' ",null);
        ...
        if(!"".equals(where)&&where!=null){
            message = JSONUtils.toJSONString(ztyjDfhscService.list(" title LIKE '%"+where+"%' OR content LIKE '%"+where+"%'  ",null));
        }else{
            message = JSONUtils.toJSONString(ztyjDfhscService.list());
        }
    ...
    private Result find() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            int i = Integer.parseInt(id);
            message = JSONUtils.toJSONString(ztyjDfhscService.find(i));
        }
