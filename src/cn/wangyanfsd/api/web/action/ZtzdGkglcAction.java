...
public class ZtzdGkglcAction extends HttpServlet {

    private ZtzdGkglcService ztzdGkglcService = (ZtzdGkglcService)new TransactionUtil().newProxy(new ZtzdGkglcServiceImpl());
    ...
    private Result save() {
        ...
        if(!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtzdGkglc ztzdGkglc = new ZtzdGkglc();
            ztzdGkglc.setTitle(title);
            ztzdGkglc.setContent(content);
            ztzdGkglc.setDate(date);
            ztzdGkglc.setPerson(person);
            ztzdGkglc.setDepartment(department);
            ztzdGkglc.setQuality(quality);
            ztzdGkglc.setPeople(people);
            ztzdGkglcService.save(ztzdGkglc);
            map.put("ztzdGkglc", ztzdGkglc);
    ...
    private Result remove() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            ...
            map.put("ztzdGkglc", ztzdGkglcService.find(i));
            ztzdGkglcService.remove(i);
    ...
    private Result update() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)&&!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtzdGkglc ztzdGkglc = new ZtzdGkglc();
            ztzdGkglc.setId(Integer.parseInt(id));
            ztzdGkglc.setTitle(title);
            ztzdGkglc.setContent(content);
            ztzdGkglc.setDate(date);
            ztzdGkglc.setPerson(person);
            ...
            ztzdGkglc.setQuality(quality);
            ztzdGkglc.setPeople(people);
            ztzdGkglcService.update(ztzdGkglc);
            map.put("ztzdGkglc", ztzdGkglc);
    ...
    private Result list() {
    	...
    	LiuLiang ll = liuLiangService.find("content = 'ZtzdGkglc' ",null);
        ...
        if(!"".equals(where)&&where!=null){
            message = JSONUtils.toJSONString(ztzdGkglcService.list(" title LIKE '%"+where+"%' OR content LIKE '%"+where+"%'  ",null));
        }else{
            message = JSONUtils.toJSONString(ztzdGkglcService.list());
        }
    ...
    private Result find() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            int i = Integer.parseInt(id);
            message = JSONUtils.toJSONString(ztzdGkglcService.find(i));
        }
