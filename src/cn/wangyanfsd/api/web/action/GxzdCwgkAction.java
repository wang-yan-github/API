...
public class GxzdCwgkAction extends HttpServlet {
    ...
    private GxzdCwgkService gxzdCwgkService = (GxzdCwgkService)new TransactionUtil().newProxy(new GxzdCwgkServiceImpl());
    ...
    private Result save() {
        ...
        if(!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            GxzdCwgk gxzdCwgk = new GxzdCwgk();
            gxzdCwgk.setTitle(title);
            gxzdCwgk.setContent(content);
            gxzdCwgk.setDate(date);
            gxzdCwgk.setPerson(person);
            gxzdCwgkService.save(gxzdCwgk);
            map.put("gxzdCwgk", gxzdCwgk);
    ...
    private Result remove() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            ...
            map.put("gxzdCwgk", gxzdCwgkService.find(i));
            gxzdCwgkService.remove(i);
    ...
    private Result update() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)&&!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            GxzdCwgk gxzdCwgk = new GxzdCwgk();
            gxzdCwgk.setId(Integer.parseInt(id));
            gxzdCwgk.setTitle(title);
            gxzdCwgk.setContent(content);
            gxzdCwgk.setDate(date);
            gxzdCwgk.setPerson(person);
            gxzdCwgkService.update(gxzdCwgk);
            map.put("gxzdCwgk", gxzdCwgk);
    ...
    private Result list() {
    	...
    	LiuLiang ll = liuLiangService.find("content = 'GxzdCwgk' ",null);
        ...
        if(!"".equals(where)&&where!=null){
            message = JSONUtils.toJSONString(gxzdCwgkService.list(" title LIKE '%"+where+"%' OR content LIKE '%"+where+"%'  ",null));
        }else{
            message = JSONUtils.toJSONString(gxzdCwgkService.list());
        }
    ...
    private Result find() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            int i = Integer.parseInt(id);
            message = JSONUtils.toJSONString(gxzdCwgkService.find(i));
        }
