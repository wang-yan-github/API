...
import cn.wangyanfsd.api.bean.ZtyjJtysj;
...
public class ZtyjJtysjAction extends HttpServlet {

    private ZtyjJtysjService ztyjJtysjService = (ZtyjJtysjService)new TransactionUtil().newProxy(new ZtyjJtysjServiceImpl());
    ...
    private Result save() {
        ...
        if(!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtyjJtysj ztyjJtysj = new ZtyjJtysj();
            ztyjJtysj.setTitle(title);
            ztyjJtysj.setContent(content);
            ztyjJtysj.setDate(date);
            ztyjJtysj.setPerson(person);
            ztyjJtysjService.save(ztyjJtysj);
            map.put("ztyjJtysj", ztyjJtysj);
    ...
    private Result remove() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            ...
            map.put("ztyjJtysj", ztyjJtysjService.find(i));
            ztyjJtysjService.remove(i);
    ...
    private Result update() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)&&!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtyjJtysj ztyjJtysj = new ZtyjJtysj();
            ztyjJtysj.setId(Integer.parseInt(id));
            ztyjJtysj.setTitle(title);
            ztyjJtysj.setContent(content);
            ztyjJtysj.setDate(date);
            ztyjJtysj.setPerson(person);
            ztyjJtysjService.update(ztyjJtysj);
            map.put("ztyjJtysj", ztyjJtysj);
    ...
    private Result list() {
    	...
    	LiuLiang ll = liuLiangService.find("content = 'ZtyjJtysj' ",null);
        ...
        if(!"".equals(where)&&where!=null){
            message = JSONUtils.toJSONString(ztyjJtysjService.list(" title LIKE '%"+where+"%' OR content LIKE '%"+where+"%'  ",null));
        }else{
            message = JSONUtils.toJSONString(ztyjJtysjService.list());
        }
    ...
    private Result find() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            int i = Integer.parseInt(id);
            message = JSONUtils.toJSONString(ztyjJtysjService.find(i));
        }
