...
public class ZtzdXzjtAction extends HttpServlet {

    private ZtzdXzjtService ztzdXzjtService = (ZtzdXzjtService)new TransactionUtil().newProxy(new ZtzdXzjtServiceImpl());
    ...
    private Result save() {
        ...
        if(!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtzdXzjt ztzdXzjt = new ZtzdXzjt();
            ztzdXzjt.setTitle(title);
            ztzdXzjt.setContent(content);
            ztzdXzjt.setDate(date);
            ztzdXzjt.setPerson(person);
            ztzdXzjt.setDepartment(department);
            ztzdXzjt.setQuality(quality);
            ztzdXzjt.setPeople(people);
            ztzdXzjtService.save(ztzdXzjt);
            map.put("ztzdXzjt", ztzdXzjt);
    ...
    private Result remove() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            ...
            map.put("ztzdXzjt", ztzdXzjtService.find(i));
            ztzdXzjtService.remove(i);
    ...
    private Result update() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)&&!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtzdXzjt ztzdXzjt = new ZtzdXzjt();
            ztzdXzjt.setId(Integer.parseInt(id));
            ztzdXzjt.setTitle(title);
            ztzdXzjt.setContent(content);
            ztzdXzjt.setDate(date);
            ztzdXzjt.setPerson(person);
            ...
            ztzdXzjt.setQuality(quality);
            ztzdXzjt.setPeople(people);
            ztzdXzjtService.update(ztzdXzjt);
            map.put("ztzdXzjt", ztzdXzjt);
    ...
    private Result list() {
    	...
    	LiuLiang ll = liuLiangService.find(" content = 'ZtzdXzjt' ",null);
        ...
        if(!"".equals(where)&&where!=null){
            message = JSONUtils.toJSONString(ztzdXzjtService.list(" title LIKE '%"+where+"%' OR content LIKE '%"+where+"%'  ",null));
        }else{
            message = JSONUtils.toJSONString(ztzdXzjtService.list());
        }
    ...
    private Result find() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            int i = Integer.parseInt(id);
            message = JSONUtils.toJSONString(ztzdXzjtService.find(i));
        }
