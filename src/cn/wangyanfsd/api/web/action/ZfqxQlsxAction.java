...
import cn.wangyanfsd.api.bean.ZfqxQlsx;
...
public class ZfqxQlsxAction extends HttpServlet {

    private ZfqxQlsxService zfqxQlsxService = (ZfqxQlsxService)new TransactionUtil().newProxy(new ZfqxQlsxServiceImpl());
    ...
    private Result save() {
        ...
        if(!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZfqxQlsx zfqxQlsx = new ZfqxQlsx();
            zfqxQlsx.setTitle(title);
            zfqxQlsx.setContent(content);
            zfqxQlsx.setDate(date);
            zfqxQlsx.setPerson(person);
            zfqxQlsxService.save(zfqxQlsx);
            map.put("zfqxQlsx", zfqxQlsx);
    ...
    private Result remove() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            ...
            map.put("zfqxQlsx", zfqxQlsxService.find(i));
            zfqxQlsxService.remove(i);
    ...
    private Result update() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)&&!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZfqxQlsx zfqxQlsx = new ZfqxQlsx();
            zfqxQlsx.setId(Integer.parseInt(id));
            zfqxQlsx.setTitle(title);
            zfqxQlsx.setContent(content);
            zfqxQlsx.setDate(date);
            zfqxQlsx.setPerson(person);
            zfqxQlsxService.update(zfqxQlsx);
            map.put("zfqxQlsx", zfqxQlsx);
    ...
    private Result list() {
    	...
    	LiuLiang ll = liuLiangService.find("content = 'ZfqxQlsx' ",null);
        ...
        if(!"".equals(where)&&where!=null){
            message = JSONUtils.toJSONString(zfqxQlsxService.list(" title LIKE '%"+where+"%' OR content LIKE '%"+where+"%'  ",null));
        }else{
            message = JSONUtils.toJSONString(zfqxQlsxService.list());
        }
    ...
    private Result find() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            int i = Integer.parseInt(id);
            message = JSONUtils.toJSONString(zfqxQlsxService.find(i));
        }
