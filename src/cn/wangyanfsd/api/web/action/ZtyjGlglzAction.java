...
import cn.wangyanfsd.api.bean.ZtyjGlglz;
...
public class ZtyjGlglzAction extends HttpServlet {

    private ZtyjGlglzService ztyjGlglzService = (ZtyjGlglzService)new TransactionUtil().newProxy(new ZtyjGlglzServiceImpl());
    ...
    private Result save() {
        ...
        if(!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtyjGlglz ztyjGlglz = new ZtyjGlglz();
            ztyjGlglz.setTitle(title);
            ztyjGlglz.setContent(content);
            ztyjGlglz.setDate(date);
            ztyjGlglz.setPerson(person);
            ztyjGlglzService.save(ztyjGlglz);
            map.put("ztyjGlglz", ztyjGlglz);
    ...
    private Result remove() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            ...
            map.put("ztyjGlglz", ztyjGlglzService.find(i));
            ztyjGlglzService.remove(i);
    ...
    private Result update() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)&&!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtyjGlglz ztyjGlglz = new ZtyjGlglz();
            ztyjGlglz.setId(Integer.parseInt(id));
            ztyjGlglz.setTitle(title);
            ztyjGlglz.setContent(content);
            ztyjGlglz.setDate(date);
            ztyjGlglz.setPerson(person);
            ztyjGlglzService.update(ztyjGlglz);
            map.put("ztyjGlglz", ztyjGlglz);
    ...
    private Result list() {
    	...
    	LiuLiang ll = liuLiangService.find("content = 'ZtyjGlglz' ",null);
        ...
        if(!"".equals(where)&&where!=null){
            message = JSONUtils.toJSONString(ztyjGlglzService.list(" title LIKE '%"+where+"%' OR content LIKE '%"+where+"%'  ",null));
        }else{
            message = JSONUtils.toJSONString(ztyjGlglzService.list());
        }
    ...
    private Result find() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            int i = Integer.parseInt(id);
            message = JSONUtils.toJSONString(ztyjGlglzService.find(i));
        }
