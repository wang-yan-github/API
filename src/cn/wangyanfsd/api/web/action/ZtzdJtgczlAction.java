...
public class ZtzdJtgczlAction extends HttpServlet {

    private ZtzdJtgczlService ztzdJtgczlService = (ZtzdJtgczlService)new TransactionUtil().newProxy(new ZtzdJtgczlServiceImpl());
    ...
    private Result save() {
        ...
        if(!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtzdJtgczl ztzdJtgczl = new ZtzdJtgczl();
            ztzdJtgczl.setTitle(title);
            ztzdJtgczl.setContent(content);
            ztzdJtgczl.setDate(date);
            ztzdJtgczl.setPerson(person);
            ztzdJtgczl.setDepartment(department);
            ztzdJtgczl.setQuality(quality);
            ztzdJtgczl.setPeople(people);
            ztzdJtgczlService.save(ztzdJtgczl);
            map.put("ztzdJtgczl", ztzdJtgczl);
    ...
    private Result remove() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            ...
            map.put("ztzdJtgczl", ztzdJtgczlService.find(i));
            ztzdJtgczlService.remove(i);
    ...
    private Result update() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)&&!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZtzdJtgczl ztzdJtgczl = new ZtzdJtgczl();
            ztzdJtgczl.setId(Integer.parseInt(id));
            ztzdJtgczl.setTitle(title);
            ztzdJtgczl.setContent(content);
            ztzdJtgczl.setDate(date);
            ztzdJtgczl.setPerson(person);
            ...
            ztzdJtgczl.setQuality(quality);
            ztzdJtgczl.setPeople(people);
            ztzdJtgczlService.update(ztzdJtgczl);
            map.put("ztzdJtgczl", ztzdJtgczl);
    ...
    private Result list() {
    	...
    	LiuLiang ll = liuLiangService.find("content = 'ZtzdJtgczl' ",null);
        ...
        if(!"".equals(where)&&where!=null){
            message = JSONUtils.toJSONString(ztzdJtgczlService.list(" title LIKE '%"+where+"%' OR content LIKE '%"+where+"%'  ",null));
        }else{
            message = JSONUtils.toJSONString(ztzdJtgczlService.list());
        }
    ...
    private Result find() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            int i = Integer.parseInt(id);
            message = JSONUtils.toJSONString(ztzdJtgczlService.find(i));
        }
