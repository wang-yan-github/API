...
import cn.wangyanfsd.api.bean.ZfjgJcjg;
...
public class ZfjgJcjgAction extends HttpServlet {

    private ZfjgJcjgService zfjgJcjgService = (ZfjgJcjgService)new TransactionUtil().newProxy(new ZfjgJcjgServiceImpl());
    ...
    private Result save() {
        ...
        if(!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZfjgJcjg zfjgJcjg = new ZfjgJcjg();
            zfjgJcjg.setTitle(title);
            zfjgJcjg.setContent(content);
            zfjgJcjg.setDate(date);
            zfjgJcjg.setPerson(person);
            zfjgJcjgService.save(zfjgJcjg);
            map.put("zfjgJcjg", zfjgJcjg);
    ...
    private Result remove() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            ...
            map.put("zfjgJcjg", zfjgJcjgService.find(i));
            zfjgJcjgService.remove(i);
    ...
    private Result update() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)&&!"".equals(title)&&title!=null&&!"".equals(content)&&content!=null&&!"".equals(date)&&date!=null&&!"".equals(person)&&person!=null){
            ZfjgJcjg zfjgJcjg = new ZfjgJcjg();
            zfjgJcjg.setId(Integer.parseInt(id));
            zfjgJcjg.setTitle(title);
            zfjgJcjg.setContent(content);
            zfjgJcjg.setDate(date);
            zfjgJcjg.setPerson(person);
            zfjgJcjgService.update(zfjgJcjg);
            map.put("zfjgJcjg", zfjgJcjg);
    ...
    private Result list() {
    	...
    	LiuLiang ll = liuLiangService.find("content = 'ZfjgJcjg' ",null);
        ...
        if(!"".equals(where)&&where!=null){
            message = JSONUtils.toJSONString(zfjgJcjgService.list(" title LIKE '%"+where+"%' OR content LIKE '%"+where+"%'  ",null));
        }else{
            message = JSONUtils.toJSONString(zfjgJcjgService.list());
        }
    ...
    private Result find() {
        ...
        if(!"".equals(id)&&id!=null&&StrUtil.isNumeric(id)){
            int i = Integer.parseInt(id);
            message = JSONUtils.toJSONString(zfjgJcjgService.find(i));
        }
